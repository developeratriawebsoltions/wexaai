    ...
    <main className="min-h-screen bg-app-surface text-app-foreground flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-xl rounded-3xl border border-app-border bg-white/95 p-10 shadow-app">
        <div className="mb-8">
          ...
          <h1 className="mt-4 text-4xl font-bold text-app-brand">Login to Wexa</h1>
          <p className="mt-3 max-w-md text-app-muted">
            Sign in and continue managing your inbox, contacts, campaigns, and AI assistant.
          </p>
        </div>
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <p className="text-center text-sm text-app-muted">
            ...
            <Link href="/signup" className="font-semibold text-app-brand hover:underline">
              Create one
            </Link>
          </p>
        </form>
