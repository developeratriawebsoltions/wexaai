export function normalizeTemplateStatus(status: string | null | undefined) {
...
export function getTemplateEventPayload(value: Record<string, any> = {}) {
...
export function parseTemplateUpdateFromChange(change: Record<string, any> | null | undefined) {
