...
export async function GET(req: NextRequest) {
  ...
  const [
    ...
    totalOutboundMessages, prevOutboundMessages,
    aiAgent,
    knowledgeCount,
    needsAttention,
    activeAgents,
    ...
    prisma.message.count({ where: { workspaceId, direction: "outbound", createdAt: { gte: day7ago } } }),
    prisma.message.count({ where: { workspaceId, direction: "outbound", createdAt: { gte: day14ago, lt: day7ago } } }),
  ...
  return NextResponse.json({
    stats: {
      ...
      outboundMsgChange: pct(totalOutboundMessages, prevOutboundMessages),
    },
    aiAgent: {
